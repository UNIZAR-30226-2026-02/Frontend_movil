    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNuevaMision.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(HomeActivity.this, "Iniciando Nueva Misión...", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnUneteMision.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(HomeActivity.this, "Buscando Misiones disponibles...", Toast.LENGTH_SHORT).show();
            }
        });
