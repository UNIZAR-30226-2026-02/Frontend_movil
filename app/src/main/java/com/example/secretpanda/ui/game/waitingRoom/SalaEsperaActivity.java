...
public class SalaEsperaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Jugadores de prueba
        Jugador j2 = new Jugador("GabriThePro"); j2.setEsEquipoAzul(false); listaJugadores.add(j2);
        Jugador j3 = new Jugador("PandaNinja"); j3.setEsEquipoAzul(true); listaJugadores.add(j3);
        Jugador j4 = new Jugador("EspiaSecreto"); j4.setEsEquipoAzul(false); listaJugadores.add(j4);
